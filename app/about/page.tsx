...
export default function AboutPage() {
  return (
    <main className="min-h-screen flex flex-col bg-white text-black">
      ...
      {/* HERO */}
      <section className="px-6 md:px-16 lg:px-24 pt-8 pb-20 md:pb-28">
      ...
      {/* BLOCO 1 */}
      <section className="px-6 md:px-16 lg:px-24 pb-10 md:pb-14">
      ...
      {/* BLOCO 2 */}
      <section className="px-6 md:px-16 lg:px-24 pb-10 md:pb-14">
        <p className="text-lg md:text-xl text-gray-500 leading-[1.85] font-light max-w-4xl">
      ...
      <section className="px-6 md:px-16 lg:px-24 pb-16 md:pb-24">
        <div className="max-w-5xl">
          {[
            ...
            <div
              key={i}
              className="border-t border-gray-100 py-8 md:py-10 flex items-start gap-6"
            >
